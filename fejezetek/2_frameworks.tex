...
\item kevés TypeScript és Angular 2 fejlesztő van, aki igazán jó fejlesztő lenne.
\end{itemize}
...
\item rendesen kidolgozott hatékony kombinációkat találni a React-al történő fejlesztéshez nem egyszerű.
\end{itemize}
