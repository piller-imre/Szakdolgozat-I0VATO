...
% TODO: Ide kellene egy szöveges bevezető rész, mert ez így elég furcsán néz ki, hogy egyből egy táblázattal kezdődik.

A bemutatott keretrendszerek néhány jellemzőjének összehasonlítása látható \aref{tab:comparison}. táblázatban. $\ldots$

% TODO: Röviden értékelni kellene a táblázatban szereplő dolgokat.
...
% TODO: Itt már nem kellene külön keretrendszereket tárgyalni, és eleve a subsubsection szint sem feltétlen idokolt. Valahogy úgy kellene leírni, hogy ha form validációról van szó, akkor melyik választásával jár jobban a fejlesztő.
...
% TODO: Olyan dolgokat is össze kellene hasonlítani, mint a dokumentáltság, függőségek, fordítási idő, sebesség az elkészült alkalmazás szempontjából.
